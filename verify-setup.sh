...
# Verificar Ansible
echo "📦 Versión de Ansible:"
ansible --version | head -n1

# Verificar configuración
echo ""
echo "⚙️ Archivo de configuración activo:"
...
if ansible-galaxy collection list 2>/dev/null | grep -q "community"; then
    ...
    echo "⚠️  Algunas colecciones pueden no estar disponibles, pero Ansible funciona"
fi
...
if [ "$group_vars_count" -gt 0 ]; then
    ...
    echo "⚠️  No se encontraron archivos de variables de grupo"
fi
